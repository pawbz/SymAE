...
eqdata = h5open("eq_sample_data_deep_2.hdf5", "r");
...
# ╔═╡ 9beaf484-c8c1-49c5-9184-137a0e0f514a
unstack

# ╔═╡ 27a72e30-f69c-4228-ab73-e13126772e73
mm=chunk(randn(4,3), 4, dims=1)

# ╔═╡ 0c488fc2-284a-4ff6-bab2-543aa56dfe66
size(mm[1]) 
...
begin
    NN = symae.get_dense_networks_new2(nt, p, q1, q2)
    sencb = symae.BroadcastSenc(NN.senc1, NN.senc2)
    nencb = symae.BroadcastNenc_new2(NN.nenc1, NN.nenc2)
...
# ╔═╡ 23671f64-7df7-4bea-b5b2-dbf0f93aeb2a
for enc in  NN.nenc1
enc(gpu(randn(1)))
end
...
begin
	plot(De, size=(650, 300), w=2, label=permutedims(cat(Dnames, dims=2),(2,1)));
...
julia_version = "1.9.1"
manifest_format = "2.0"
project_hash = "0755a75440a34adb7bf5d858592cc1d1b4c0130c"
